                 ...
                 gpointer         user_data)
{
  ...
  EosKolibriSessionHelper *session_helper = NULL;
  char *path;

  manager = g_dbus_object_manager_server_new ("/org/endlessos/KolibriSessionHelper");

  path = g_strdup ("/org/endlessos/KolibriSessionHelper/Core");
  session_helper = eos_kolibri_session_helper_new ();
  eos_kolibri_session_helper_export_dbus_object (session_helper, manager, path);
  g_free (path);
...
main (int argc, char *argv[])
{
  ...
  g_option_context_set_summary (context, "Kolibri session helper");
  ...
  bus_owner_id = g_bus_own_name (G_BUS_TYPE_SESSION,
                                 "org.endlessos.KolibriSessionHelper",
                                 bus_flags,
                                 on_bus_acquired,
                                 on_name_acquired,
                                 on_name_lost,
